# Autodesk App Store Listing Draft — Amentum Revit 2026 (Enterprise Version)
...
Amentum Revit is a Revit 2026 add-in for structured parameter exchange, CAD coordination, shared-parameter administration, and controlled model export workflows.

## Enterprise Description

Amentum Revit is a Windows-based Autodesk Revit 2026 add-in intended for disciplined project delivery and internal engineering workflows.
...
This release is scoped specifically to Autodesk Revit 2026 and is packaged for straightforward deployment through standard Autodesk bundle installation paths. The package is branded for Amentum and includes updated support and contact metadata for enterprise distribution.
...
4. Restart Autodesk Revit 2026.
5. Confirm that the **Amentum** ribbon tab is available.

## Deployment Notes

- This package is prepared for Revit 2026 only.
...
- Established Amentum-branded Revit 2026 package
...
- Aligned package manifest and deliverable naming to Revit 2026 scope
...
Amentum, Autodesk Revit 2026, enterprise, Excel parameter exchange, CAD sync, DWG export, shared parameters, batch workflows

## Submission Guidance

- Use this description where a formal or procurement-oriented tone is preferred.
- Do not describe this package as supporting Revit 2025 or Revit 2027.
